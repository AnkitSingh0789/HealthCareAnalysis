...
# Dummy data for all 36 states and union territories for Cancer analysis
data = {
    ...
    'Cases': [800000, 45000, 500000, 900000, 600000, 80000, 1200000, 650000, 350000, 700000, 1800000, 
              1700000, 1400000, 2500000, 300000, 400000, 150000, 250000, 1000000, 800000, 1200000, 100000, 
              1900000, 1000000, 300000, 1400000, 400000, 1600000, 50000, 80000, 70000, 1300000, 40000, 100000, 
              45000, 300000],
    'Deaths': [40000, 1500, 12000, 25000, 18000, 2000, 30000, 22000, 10000, 18000, 42000, 
               40000, 35000, 70000, 8000, 12000, 6000, 10000, 24000, 20000, 30000, 4000, 
               44000, 24000, 7000, 32000, 8000, 40000, 2000, 2500, 2000, 35000, 1000, 3000, 
               1200, 10000],
    'Recovered': [500000, 25000, 300000, 550000, 350000, 50000, 750000, 450000, 200000, 500000, 1200000, 
                  1100000, 900000, 1800000, 150000, 250000, 90000, 150000, 700000, 500000, 800000, 70000, 
                  1300000, 700000, 180000, 900000, 250000, 1100000, 35000, 60000, 50000, 950000, 25000, 60000, 
                  30000, 200000],
    'Active': [260000, 18500, 188000, 325000, 232000, 28000, 420000, 178000, 140000, 182000, 580000, 
               530000, 465000, 700000, 142000, 138000, 54000, 90000, 290000, 280000, 320000, 26000, 
               560000, 260000, 113000, 480000, 142000, 500000, 13000, 17500, 18000, 315000, 13000, 37000, 
               13800, 90000]
}
...
def create_charts(top_states, top_n):
    ...
    bar_fig = px.bar(
        ...
        x='State',
        y='Cases',
        title=f'Top {top_n} States in India: Cancer Cases',
    ...
    pie_fig = go.Figure(
        ...
        layout=go.Layout(
            title=f'Distribution of Cancer Cases in Top {top_n} States',
            updatemenus=[{
                'type': 'buttons',
                'buttons': [{
                    'label': 'Play',
    ...
    area_fig = go.Figure(
        ...
        layout=go.Layout(
            title=f'Area Chart for Cancer Cases in Top {top_n} States',
            xaxis_title='State',
            yaxis_title='Number of Cases',
